...
export default async function sendTimesheet(req, res, next) {
    ...
    doc.text(`Jobsite: ${timesheet && timesheet.days[1].jobsite}`, 105, 60)
    doc.text(`Other Jobsite: ${timesheet && timesheet.days[1].additional} `, 155, 60)
    ...
    doc.text(`Other Jobsite: ${timesheet && timesheet.days[2].additional} `, 155, 100)
    ...
    doc.text(`Other Jobsite: ${timesheet && timesheet.days[3].additional} `, 155, 140)
    ...
    doc.text(`Other Jobsite: ${timesheet && timesheet.days[4].additional} `, 155, 180)

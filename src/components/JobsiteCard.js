...
const JobsiteCard = ( { jobsite } ) => {
  ...
  return (
    <div className='border-[1px] border-black w-full md:w-[500px] h-[650px] basic-container m-2'>
          <h1 className='border-[1px] border-white p-2 rounded-lg font-extrabold text-3xl flex items-center justify-between'>{jobsite.name}<button className='bg-red-700 p-1 border rounded' onClick={handleDelete}>{trashLogo}</button></h1>
